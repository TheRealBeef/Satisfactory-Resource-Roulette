...
const TMap<FName, FResourceRouletteAssetHeat> UResourceRouletteAssets::HeatResourceInfoMap = {
    { "Desc_Geyser_C", FResourceRouletteAssetHeat{
        "/Game/FactoryGame/Resource/RawResources/Geysers/GeyserNode.GeyserNode",
        { "/Game/FactoryGame/Resource/RawResources/Geysers/Material/Geyser_Material.Geyser_Material" },
        FVector(0.0f, 0.0f, 100.0f),
        FVector(3.0f, 3.0f, 3.0f)
    }}
};
// Liquid resources (e.g., Oil with decals)
...
TArray<FString> UResourceRouletteAssets::GetFrackingMaterisl(const FName& ResourceClass)
{
    if (FrackingResourceInfoMap.Contains(ResourceClass))
    {
